...
namespace EchoesOfTheRuins
{
    ...
    public sealed class CanvasHud : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (player != null) { player.EchoStoneCountChanged += OnEchoes; OnEchoes(player.EchoStoneCount); } if (interactor != null) interactor.PromptChanged += OnPrompt;
        }
        private void Update() { if (tutorial == null) tutorial = TutorialDirector.Active; if (tutorial != null) { tutorialText.text = TutorialCopy.Get(tutorial.Stage); tutorialPanel.SetActive(tutorial.Stage != TutorialStage.Complete); } }
        ...
        private void OnDestroy() { if (objectives != null) objectives.ObjectiveChanged -= OnObjective; if (threat != null) threat.Changed -= OnThreat; if (player != null) player.EchoStoneCountChanged -= OnEchoes; if (interactor != null) interactor.PromptChanged -= OnPrompt; }
